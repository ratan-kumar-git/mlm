...
const Loginpage = () => {
  ...
  return (
    <div className="w-full bg-black min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-[90vw] sm:max-w-md w-full bg-card p-4 rounded-md flex items-center flex-col justify-center space-y-8 mx-auto sm:shadow-[5px_5px_rgba(0,98,90,0.4),10px_10px_rgba(0,98,90,0.3),15px_15px_rgba(0,98,90,0.2),20px_20px_rgba(0,98,90,0.1),25px_25px_rgba(0,98,90,0.05)]">
        {/* Logo */}
        <Image
          src="/logoIcon.png"
          height={60}
